package lessons.lesson_02.draw_pic.sprites;
...
public class Picture extends Sprite {
    ...
    public Picture(int x, int y){
        ...
        halfWidth = 62;
        try {
            image = ImageIO.read(new File("C:\\Users\\Predator\\IdeaProjects\\GB\\gb-java-jdk-2024\\" +
                    "src\\main\\java\\lessons\\lesson_02\\draw_pic\\resource\\picachu.png"));
        } catch (IOException e) {
